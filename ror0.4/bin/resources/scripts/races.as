...
// public functions
	...
	{		
		...
		else
		{
			...
			game.setDirectionArrow(this.raceList[this.currentRace].raceName+"\ncheckpoint "+position+" / "+(this.raceList[this.currentRace].checkPointsCount), vector3(v[0], v[1], v[2]));
		}
	}
